...
```sh
deno run --allow-net https://deno.land/x/vofarm@v1.0.0/src/start-centralized-vofarming.ts <yourbybitapikey> <yourbybitapisecret> BybitConnector LongShortClassics 0 22
```
