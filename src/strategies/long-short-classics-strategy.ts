...
export abstract class LongShortClassics extends VoFarmStrategy {
    ...
    protected async playAsset(assetInfo: AssetInfo, exchangeConnector: IExchangeConnector): Promise<void> {
        ...
        } else if (this.liquidityLevel > 3 && longPosition.data.unrealised_pnl < 0 && shortPosition.data.unrealised_pnl < 0) {
    ...
    protected getAssetsToPlayWith(): AssetInfo[] {
        return [
            ...
            { pair: "AAVEUSDT", minTradingAmount: 1, decimalPlaces: 0, targetLSD: 0, minLSD: -10, maxLSD: 10 },
            { pair: "BNBUSDT", minTradingAmount: 0.01, decimalPlaces: 2, targetLSD: 0, minLSD: -10, maxLSD: 10 },
            { pair: "SOLUSDT", minTradingAmount: 0.1, decimalPlaces: 1, targetLSD: 0, minLSD: -10, maxLSD: 10 },
            { pair: "ADAUSDT", minTradingAmount: 1, decimalPlaces: 0, targetLSD: 0, minLSD: -10, maxLSD: 10 },
            { pair: "DOTUSDT", minTradingAmount: 1, decimalPlaces: 0, targetLSD: 0, minLSD: -10, maxLSD: 10 },
            { pair: "LUNAUSDT", minTradingAmount: 0.1, decimalPlaces: 1, targetLSD: 0, minLSD: -10, maxLSD: 10 },
            { pair: "BATUSDT", minTradingAmount: 1, decimalPlaces: 0, targetLSD: 0, minLSD: -10, maxLSD: 10 },
            { pair: "FILUSDT", minTradingAmount: 1, decimalPlaces: 0, targetLSD: 0, minLSD: -10, maxLSD: 10 },
            { pair: "XLMUSDT", minTradingAmount: 1, decimalPlaces: 0, targetLSD: 0, minLSD: -10, maxLSD: 10 },
            { pair: "MANAUSDT", minTradingAmount: 1, decimalPlaces: 0, targetLSD: 0, minLSD: -10, maxLSD: 10 },
            { pair: "ICPUSDT", minTradingAmount: 1, decimalPlaces: 0, targetLSD: 0, minLSD: -10, maxLSD: 10 },
            { pair: "VETUSDT", minTradingAmount: 10, decimalPlaces: 0, targetLSD: 0, minLSD: -10, maxLSD: 10 },
            { pair: "COMPUSDT", minTradingAmount: 0.1, decimalPlaces: 1, targetLSD: 0, minLSD: -10, maxLSD: 10 },
            { pair: "XTZUSDT", minTradingAmount: 1, decimalPlaces: 0, targetLSD: 0, minLSD: -10, maxLSD: 10 },
            { pair: "THETAUSDT", minTradingAmount: 1, decimalPlaces: 0, targetLSD: 0, minLSD: -10, maxLSD: 10 },
            { pair: "ETCUSDT", minTradingAmount: 0.1, decimalPlaces: 1, targetLSD: 0, minLSD: -10, maxLSD: 10 },
            { pair: "HBARUSDT", minTradingAmount: 1, decimalPlaces: 0, targetLSD: 0, minLSD: -10, maxLSD: 10 },
            { pair: "EGLDUSDT", minTradingAmount: 0.01, decimalPlaces: 2, targetLSD: 0, minLSD: -10, maxLSD: 10 },
            { pair: "ATOMUSDT", minTradingAmount: 0.1, decimalPlaces: 1, targetLSD: 0, minLSD: -10, maxLSD: 10 },
            { pair: "TRXUSDT", minTradingAmount: 10, decimalPlaces: 0, targetLSD: 0, minLSD: -10, maxLSD: 10 },
            { pair: "ALGOUSDT", minTradingAmount: 1, decimalPlaces: 0, targetLSD: 0, minLSD: -10, maxLSD: 10 },
            { pair: "BCHUSDT", minTradingAmount: 0.01, decimalPlaces: 2, targetLSD: 0, minLSD: -10, maxLSD: 10 },
            { pair: "MATICUSDT", minTradingAmount: 1, decimalPlaces: 0, targetLSD: 0, minLSD: -10, maxLSD: 10 },
            { pair: "DOGEUSDT", minTradingAmount: 1, decimalPlaces: 0, targetLSD: 0, minLSD: -10, maxLSD: 10 },
            { pair: "XRPUSDT", minTradingAmount: 1, decimalPlaces: 0, targetLSD: 0, minLSD: -10, maxLSD: 10 },
            { pair: "LTCUSDT", minTradingAmount: 0.1, decimalPlaces: 1, targetLSD: 0, minLSD: -10, maxLSD: 10 },
            { pair: "SANDUSDT", minTradingAmount: 1, decimalPlaces: 0, targetLSD: 0, minLSD: -10, maxLSD: 10 },
            { pair: "BITUSDT", minTradingAmount: 1, decimalPlaces: 0, targetLSD: 0, minLSD: -10, maxLSD: 10 },
            { pair: "IOTXUSDT", minTradingAmount: 10, decimalPlaces: 0, targetLSD: 0, minLSD: -10, maxLSD: 10 },
            { pair: "DYDXUSDT", minTradingAmount: 1, decimalPlaces: 0, targetLSD: 0, minLSD: -10, maxLSD: 10 },
            { pair: "SUSHIUSDT", minTradingAmount: 1, decimalPlaces: 0, targetLSD: 0, minLSD: -10, maxLSD: 10 },
            { pair: "CRVUSDT", minTradingAmount: 1, decimalPlaces: 0, targetLSD: 0, minLSD: -10, maxLSD: 10 },
            { pair: "ENJUSDT", minTradingAmount: 1, decimalPlaces: 0, targetLSD: 0, minLSD: -10, maxLSD: 10 },
            { pair: "AXSUSDT", minTradingAmount: 0.1, decimalPlaces: 1, targetLSD: 0, minLSD: -10, maxLSD: 10 },
            { pair: "FTMUSDT", minTradingAmount: 1, decimalPlaces: 0, targetLSD: 0, minLSD: -10, maxLSD: 10 },
            { pair: "GALAUSDT", minTradingAmount: 1, decimalPlaces: 0, targetLSD: 0, minLSD: -10, maxLSD: 10 },
            { pair: "EOSUSDT", minTradingAmount: 1, decimalPlaces: 0, targetLSD: 0, minLSD: -10, maxLSD: 10 },
            { pair: "LRCUSDT", minTradingAmount: 1, decimalPlaces: 0, targetLSD: 0, minLSD: -10, maxLSD: 10 },
            { pair: "GRTUSDT", minTradingAmount: 1, decimalPlaces: 0, targetLSD: 0, minLSD: -10, maxLSD: 10 },
            { pair: "FLOWUSDT", minTradingAmount: 1, decimalPlaces: 0, targetLSD: 0, minLSD: -10, maxLSD: 10 },
            { pair: "KSMUSDT", minTradingAmount: 0.1, decimalPlaces: 1, targetLSD: 0, minLSD: -10, maxLSD: 10 },
            { pair: "ZECUSDT", minTradingAmount: 0.01, decimalPlaces: 2, targetLSD: 0, minLSD: -10, maxLSD: 10 },
            { pair: "ONEUSDT", minTradingAmount: 1, decimalPlaces: 0, targetLSD: 0, minLSD: -10, maxLSD: 10 },
            { pair: "RUNEUSDT", minTradingAmount: 1, decimalPlaces: 0, targetLSD: 0, minLSD: -10, maxLSD: 10 },
            { pair: "CHZUSDT", minTradingAmount: 1, decimalPlaces: 0, targetLSD: 0, minLSD: -10, maxLSD: 10 },
        ]
    }
