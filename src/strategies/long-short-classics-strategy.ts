...
export abstract class LongShortClassics extends VoFarmStrategy {
    ...
    protected getAssetsToPlayWith(): AssetInfo[] {
        return [
            ...
            { pair: "DOGEUSDT", minTradingAmount: 1, decimalPlaces: 0, targetLSD: -2, minLSD: -4, maxLSD: 5 },
            { pair: "XRPUSDT", minTradingAmount: 1, decimalPlaces: 0, targetLSD: -2, minLSD: -4, maxLSD: 5 },
