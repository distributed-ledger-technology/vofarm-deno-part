...
//     protected async deriveInvestmentAdvice(investmentOption: AssetInfo, move: Action, investmentDecisionBase: any, lsd: number, ll: number, longP: any, shortP: any): Promise<void> {
...
//     protected closeAll(investmentOption: AssetInfo, specificmessage: string, longP: any, shortP: any): void {
...
//     protected checkSetup(investmentOption: AssetInfo, longP: any, shortP: any): void {
//         if (longP === undefined) {
...
//     protected async deriveStandardMoves(investmentOption: AssetInfo, move: Action, lsd: number, ll: number, longP: any, shortP: any): Promise<void> {
...
//     protected deriveSpecialMoves(investmentOption: AssetInfo, investmentDecisionBase: any, ll: number, longP: any, shortP: any): void {
